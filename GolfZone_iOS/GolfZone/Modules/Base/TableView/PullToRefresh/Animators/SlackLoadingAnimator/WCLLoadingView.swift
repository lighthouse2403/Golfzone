...
//  GolfZone
//
//  Created by Dang Nguyen on 20/12/2022.
//
...
class WCLLoadingView: UIView, CAAnimationDelegate {
    ...
    var colors:[UIColor] = [UIColor(hexString: "#9DD2E9") , UIColor(hexString: "#F5BD58"),  UIColor(hexString: "#FF317E") , UIColor(hexString: "#6FC9B5")]
